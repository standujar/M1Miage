...
public class SerializedResultSet implements java.io.Serializable {
  ...
  private java.util.LinkedList<LinkedList> lstColumnData = new java.util.LinkedList<LinkedList>();
...
public int recordCount() {
    try {
      java.util.LinkedList columnData = lstColumnData.
          get(0);
...
public void addColumnData(int ColumnNumber, Object newValue) {
    lstColumnData.get(ColumnNumber - 1).addLast(newValue);
}
...
public void addColumn(String columnName, int columnSequence) {
    ...
    lstColumnData.get(columnSequence - 1).clear();
  }
}
